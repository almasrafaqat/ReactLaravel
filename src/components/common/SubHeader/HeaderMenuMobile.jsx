...
const NavClose = (e) => {
  ...
  return (
    <Fragment>
      ...
      <div className={`mobile-header-active mobile-header-wrapper-style ${props.NavOpen}`}>
        <div className="mobile-header-wrapper-inner">
          <div className="mobile-header-top">
            <div className="mobile-header-logo">
              <a href="index.html">
                <img src={HeaderImage.Logo} alt="logomobile" />
              </a>
            </div>
            <div className="mobile-menu-close close-style-wrap close-style-position-inherit" onClick={() => props.onChange("")}>
